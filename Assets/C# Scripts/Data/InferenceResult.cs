    ...
    public struct InferenceResult
    {
        ...
        public static EvaluationResult GetEvaluationResult(string evaluation)
        {
            switch (evaluation)
            {
                case "CompletelyCorrect":
                    return EvaluationResult.CompletelyCorrect;
                case "PartiallyCorrect":
                    return EvaluationResult.PartiallyCorrect;
                case "Incorrect":
                    return EvaluationResult.Incorrect;
                case "Noncommittal":
                    return EvaluationResult.Noncommittal;
                case "Irrelevant":
                    return EvaluationResult.Irrelevant;
                default:
